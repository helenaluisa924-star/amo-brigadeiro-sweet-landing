...
const products = [
  { img: imgClassic, name: "A gente ama, você ama e como o Brigadeiro da Amo, você nunca viu!", desc: "Clássico - Brigadeiro Tradicional" },
  { img: imgPistache, name: "Ninho", desc: "Cremoso e delicado, sabor que abraça." },
